...
export default class ComponentTypes extends Component {
    ...
    render(){
        ...
        return(
            <>
                <hr/>
                {/* passing age data from here to the parent component(Home) as function parameter*/}
                {/* run and click on pass tp parent button, the age in the home component would be changed*/}
